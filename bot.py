...
class AjedrezMoveView(discord.ui.View):
    ...
    @discord.ui.button(label="Mover", style=discord.ButtonStyle.primary, emoji="♟️")
    async def mover_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
    ...
    async def rendirse_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.terminado = True
        self.abandono = True
...
class AjedrezCog(commands.Cog):
    ...
    async def _resolver_ajedrez(self, msg: discord.Message, view: AjedrezJoinView):
        ...
        while not board.is_game_over():
            ...
            try:
                await msg.edit(embed=emb, view=move_view)
            except discord.HTTPException:
                pass
...
class HelpCog(commands.Cog):
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        embed.add_field(name="♟️ Ajedrez", value=(
            ...
            "Cada turno puedes pulsar **Mover** para escribir tu jugada (notación SAN como `e4`, `Cf3`, `Dxe5`, o UCI como `e2e4`) o **Rendirse**."
        ), inline=False)
